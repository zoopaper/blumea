...
<head>
	...
	<title>Grid | Melon - Flat &amp; Responsive Admin Template</title>
	...
	<div id="container">
		...
		<div id="content">
			<div class="container">
					...
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> Grid Options</h4>
							</div>
				...
				<div class="row">
					<div class="col-md-12">
						<h5 class="widget-title"><i class="icon-sign-blank"></i> Boxed Example</h5>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> Minimal</h4>
							</div>
							<div class="widget-content">
					...
					<div class="col-md-6">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i> With Toolbar</h4>
				...
				<div class="row">
					<div class="col-md-12">
						<h5 class="widget-title"><i class="icon-unchecked"></i> Unboxed Example</h5>
					</div>
				</div>
