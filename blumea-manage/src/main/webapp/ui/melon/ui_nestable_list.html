...
<head>
	...
	<title>Nestable List | Melon - Flat &amp; Responsive Admin Template</title>
	...
	<script type="text/javascript" src="assets/js/demo/ui_nestable_list.js"></script>
</head>
	...
	<div id="container">
		...
		<div id="content">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h5 class="widget-title"><i class="icon-code"></i> Serialised Output (per list)</h5>
						<div class="form-group">
							<textarea id="nestable_list_1_output" class="form-control"></textarea>
						</div>
						<div class="form-group">
							<textarea id="nestable_list_2_output" class="form-control"></textarea>
						</div>
					...
					<div class="col-md-6">
						<div class="widget box">
							<div class="widget-header">
									<h4><i class="icon-reorder"></i> Nestable List 1</h4>
								</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
									<h4><i class="icon-reorder"></i> Nestable List 3 (Draggable Handles)</h4>
								</div>
							<div class="widget-content">
								<!-- Nestable List 3 -->
